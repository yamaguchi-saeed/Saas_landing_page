...
export const plans = [
	{
		...
		priceMonthly: 29,
		priceYearly: 19,
		caption: "Ideal for Individual Creators",
		features: [
			"100MB Cloud storage",
	...
	},
	{
		...
		priceMonthly: 49,
		priceYearly: 39,
		caption: "Best Value Plan",
		features: [
			"Access to all Starter features",
			"1TB of extra storage",
			"Unlimited projects",
			"Analytics",
		],
	...
	},
	{
		...
		priceMonthly: 69,
		priceYearly: 59,
		caption: "Teamwork Essentials Plan",
		features: [
			"Access to All Overdrive Features",
			"10TB of Extra Storage",
			"50% Savings per Member on Individual rates",
